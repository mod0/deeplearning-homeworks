...
params = hw2.initialize(eta = 0.01, maxiter = 30, early_termination = False)
...
keras_model.add(Dense(3, activation='sigmoid', use_bias = False, kernel_initializer='random_normal', input_dim = 2))
keras_model.add(Dense(3, activation='sigmoid', use_bias = False, kernel_initializer='random_normal'))
